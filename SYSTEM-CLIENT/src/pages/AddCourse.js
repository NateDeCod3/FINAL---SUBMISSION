...
export default function AddCourse(){
    ...
    return(
        <Container fluid className="vh-100 p-5">
            ...
            <Form className="w-100 p-5 shadow rounded-3 border-bottom border-3 border-secondary" onSubmit={(e) => addCourse(e)}>
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                <Button variant="secondary" className="w-100 rounded-pill" type="submit">ADD COURSE</Button>
            </Form.Group>
