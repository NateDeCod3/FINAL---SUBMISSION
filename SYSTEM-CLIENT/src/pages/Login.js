...
export default function Login(){
    ...
    return(
        ...
        <Container fluid className="vh-100">
            <Row>
                <Col className="vh-100 bg-primary col-6 d-flex flex-column align-items-center justify-content-center text-center text-white">
                ...
                <Col className="vh-100 col-6">
                    <Container fluid className="p-5 d-flex flex-column align-items-center justify-content-center vh-100">
                        ...
                        <Form className="w-100 p-5 shadow rounded-3 border-bottom border-3 border-primary" onSubmit={e => loginUser(e)}>
